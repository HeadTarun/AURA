...
export default function SignupPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const data = (await response.json()) as Partial<SignupResponse> & {
        error?: string;
      };
    ...
    <main className="login-screen">
      ...
      <section className="login-stage signup-stage" aria-labelledby="signup-heading">
        ...
        <form className="login-card signup-card" onSubmit={handleSubmit} noValidate>
          <div className="provider-grid" aria-label="Social signup options">
          ...
          <p className="terms-copy">
            By signing up, I agree to AI Tutor&apos;s <Link href="/terms">Terms</Link>.
          </p>
